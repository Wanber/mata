...
if(! defined('MAX_WIDTH') )					define ('MAX_WIDTH', 2000);								// Maximum image width
...
if(! defined('DEFAULT_Q') )					define ('DEFAULT_Q', 60);								// Default image quality. Allows overrid in timthumb-config.php
...
define ('LOCAL_FILE_BASE_DIRECTORY', dirname(__FILE__));
...
class timthumb {
    ...
    protected function processImageAndWriteToCache($localImage){
        ...
        if ($new_width == 0 && $new_height == 0) {
            list($img_width, $img_height) = getimagesize($localImage);
            $new_width = $img_width;
