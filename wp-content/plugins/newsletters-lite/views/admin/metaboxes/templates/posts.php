		...
		<tr>
			...
			<td>
				...
				<div class="howto">
					...
					<code>[newsletters_post_thumbnail size="thumbnail" hspace="15" align="left"]</code> <?php _e('The thumbnail (if any) of the post with an optional "size" parameter.', $this -> plugin_name); ?><br/>
