		...
		<div class="tablenav">
			<div class="alignleft actions">
				...
				<?php if (!empty($rssfeed) && $rssfeed == "Y" && apply_filters($this -> pre . '_admin_history_rsslink', true)) : ?>
					<a href="<?php echo esc_url(add_query_arg(array('feed' => "newsletters"), home_url())); ?>" title="<?php _e('RSS feed for all newsletter history', $this -> plugin_name); ?>" class="button"><i class="fa fa-rss"></i> <?php _e('RSS', $this -> plugin_name); ?></a>
				<?php endif; ?>
